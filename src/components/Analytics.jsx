            ...
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 ">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <p className="">
                        ...
                        Nostrum iste rem quae est, blanditiis ducimus nobis
                        dolorem nihil, nulla, eligendi possimus at. Corrupti at
                        reprehenderit dignissimos libero magnam incidunt
                        accusamus!
                    </p>
